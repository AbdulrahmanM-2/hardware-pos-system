...
import { ShoppingCart, Package, AlertTriangle, Search, Plus, Minus, X, Trash2, BarChart3, DollarSign, Box, History, Download, Globe, Receipt, LogOut, User } from 'lucide-react';
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-zinc-400 text-sm font-mono">POINT OF SALE SYSTEM v4.1{demoMode ? ' (Demo Mode)' : ''}</p>
              </div>
            </div>
