...
export default function HardwarePOS() {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 text-zinc-100 font-sans">
      ...
      {showProductModal && (
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center p-4 z-50">
          <div className="bg-zinc-800 text-zinc-100 max-w-2xl w-full p-8 relative border-l-4 border-yellow-500 max-h-[90vh] overflow-y-auto">
            <button
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g., 2x4x8 Lumber"
                  className="w-full p-3 bg-zinc-900 border-2 border-zinc-700 text-zinc-100 focus:border-yellow-500 focus:outline-none"
                  required
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-bold mb-2 uppercase">SKU *</label>
                  <input
                    type="text"
                    value={productForm.sku}
                    onChange={(e) => handleProductFormChange('sku', e.target.value)}
                    placeholder="e.g., LMB-001"
                    className="w-full p-3 bg-zinc-900 border-2 border-zinc-700 text-zinc-100 focus:border-yellow-500 focus:outline-none"
                    required
                  />
                </div>
              ...
              {/* Price */}
              <div>
                <label className="block text-sm font-bold mb-2 uppercase">{t.price} (TZS) *</label>
                <input
                  type="number"
                  value={productForm.price}
                  onChange={(e) => handleProductFormChange('price', e.target.value)}
                  placeholder="e.g., 22000"
                  className="w-full p-3 bg-zinc-900 border-2 border-zinc-700 text-zinc-100 font-mono focus:border-yellow-500 focus:outline-none"
                  required
                  min="0"
                  step="100"
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="block text-sm font-bold mb-2 uppercase">{t.stock}</label>
                  <input
                    type="number"
                ...
                <div>
                  <label className="block text-sm font-bold mb-2 uppercase">{t.minimumStock}</label>
                  <input
                    type="number"
              ...
              {/* Barcode (Optional) */}
              <div>
                <label className="block text-sm font-bold mb-2 uppercase">BARCODE (Optional)</label>
                <input
                  type="text"
                  ...
                  className="w-full p-3 bg-zinc-900 border-2 border-zinc-700 text-zinc-100 font-mono focus:border-yellow-500 focus:outline-none"
                />
                <p className="text-xs text-zinc-400 mt-1">For quick scanning at checkout</p>
              </div>

              <p className="text-xs text-zinc-400 italic">* Required fields</p>
            </div>

            <div className="flex gap-2 mt-6">
              <button
                onClick={saveProduct}
                className="flex-1 bg-yellow-500 hover:bg-yellow-400 text-zinc-900 py-4 font-black text-xl uppercase tracking-wide transition-colors"
              >
              ...
              <button
                onClick={() => setShowProductModal(false)}
                className="flex-1 bg-zinc-700 hover:bg-zinc-600 py-4 font-bold uppercase transition-colors"
              >
                {t.cancel}
              </button>
            </div>
      ...
      {showScannerModal && (
        <div className="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center p-4 z-50">
          <div className="bg-zinc-800 text-zinc-100 max-w-lg w-full p-8 relative border-l-4 border-yellow-500">
            <button
              onClick={() => {
                stopCameraScanner();
                setShowScannerModal(false);
            ...
            <div className="flex gap-2 mb-6">
              <button
                ...
                className={`flex-1 py-3 px-4 font-bold uppercase transition-all flex items-center justify-center gap-2 ${
                  scannerMode === 'camera' ? 'bg-yellow-500 text-zinc-900' : 'bg-zinc-700 hover:bg-zinc-600'
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 py-3 px-4 font-bold uppercase transition-all flex items-center justify-center gap-2 ${
                  scannerMode === 'usb' ? 'bg-yellow-500 text-zinc-900' : 'bg-zinc-700 hover:bg-zinc-600'
                }`}
              >
                <Scan className="w-5 h-5" />
                USB SCANNER
            ...
            {/* Camera Scanner */}
            {scannerMode === 'camera' && (
              <div className="bg-zinc-900 p-4 mb-4">
            ...
            {/* USB Scanner */}
            {scannerMode === 'usb' && (
              <div className="bg-zinc-900 p-6 mb-4">
                ...
                <input
                  ...
                  onKeyPress={handleUSBScan}
                  placeholder="Scan barcode or type manually..."
                  className="w-full p-4 bg-zinc-800 border-2 border-zinc-700 text-zinc-100 font-mono text-lg focus:border-yellow-500 focus:outline-none"
                  autoFocus
                />
                <p className="text-xs text-zinc-400 mt-3">
                  • Scan with USB barcode scanner<br />
            ...
            <div className="bg-zinc-900 p-4 border-l-2 border-yellow-500">
              <p className="text-sm font-bold text-yellow-500 mb-2">HOW IT WORKS:</p>
              <ul className="text-xs text-zinc-400 space-y-1">
                <li>• Product found → Added to cart automatically</li>
                <li>• Product not found → Search manually or add new product</li>
                <li>• Add barcodes to products in Inventory tab</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center p-4 z-50">
          <div className="bg-zinc-800 text-zinc-100 max-w-md w-full p-8 relative border-l-4 border-yellow-500">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-sm font-bold mb-2 uppercase">Email (Optional)</label>
                <input
                  type="email"
              ...
              <div>
                <label className="block text-sm font-bold mb-2 uppercase">Address (Optional)</label>
                <textarea
                  value={customerForm.address}
                  onChange={(e) => handleCustomerFormChange('address', e.target.value)}
                  placeholder="Customer address"
                  rows={3}
                  className="w-full p-3 bg-zinc-900 border-2 border-zinc-700 text-zinc-100 focus:border-yellow-500 focus:outline-none resize-none"
                />
              </div>
            </div>
            ...
            <div className="flex gap-2 mt-6">
              <button
                onClick={addCustomer}
                className="flex-1 bg-yellow-500 hover:bg-yellow-400 text-zinc-900 py-3 font-black uppercase"
              >
                ADD CUSTOMER
              </button>
              <button
                onClick={() => setShowCustomerModal(false)}
                className="flex-1 bg-zinc-700 hover:bg-zinc-600 py-3 font-bold uppercase"
              >
                CANCEL
              </button>
            </div>
          ...
          <div className="bg-zinc-800 text-zinc-100 max-w-2xl w-full p-8 relative border-l-4 border-yellow-500 max-h-[90vh] overflow-y-auto">
            ...
            {customers.length === 0 ? (
              <div className="text-center py-12">
                <Users className="w-16 h-16 mx-auto mb-4 opacity-50" />
                <p className="font-bold mb-4">No customers yet</p>
                <button
                  onClick={() => {
                    setShowCustomerLookup(false);
                    setShowCustomerModal(true);
                  }}
                  className="px-6 py-3 bg-yellow-500 hover:bg-yellow-400 text-zinc-900 font-black uppercase"
                >
                  ADD FIRST CUSTOMER
                </button>
              </div>
                ...
                {customers.map(customer => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-zinc-900 p-4 border-l-2 border-zinc-700 hover:border-yellow-500 cursor-pointer transition-all"
                    >
                      <div className="flex justify-between items-start">
                        <div>
                          <h3 className="font-bold text-lg">{customer.name}</h3>
                          <p className="text-sm text-zinc-400 font-mono">{customer.phone}</p>
                        </div>
                        <span className={`px-2 py-1 text-xs font-black ${tier.color}`}>
                          {tier.tier}
                        </span>
                      ...
                      <div className="mt-2 grid grid-cols-3 gap-2 text-xs">
                        <div>
                          <span className="text-zinc-400">Points:</span>
                          <span className="font-bold ml-1">{customer.points}</span>
                        </div>
                        <div>
                          <span className="text-zinc-400">Discount:</span>
                          <span className="font-bold text-green-400 ml-1">{(tier.discount * 100).toFixed(0)}%</span>
                        </div>
                        <div>
                          <span className="text-zinc-400">Visits:</span>
                          <span className="font-bold ml-1">{customer.visits}</span>
                        </div>
                      </div>
                    </div>
                  );
